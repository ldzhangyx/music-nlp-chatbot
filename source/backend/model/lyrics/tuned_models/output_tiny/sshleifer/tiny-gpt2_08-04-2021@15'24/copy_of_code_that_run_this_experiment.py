...
from transformers import AutoTokenizer, AutoModelWithLMHead # for smaller ver.
...
def init_args():
    ...
    # Model hyperparams
    parser.add_argument("--model_size", type=str, default="sshleifer/tiny-gpt2", help="Model size (gpt2, gpt2-medium, distilgpt2).")
...
def main():
    ...
    special_tokens_dict = {
        "additional_special_tokens": [
            '[s:tags]', '[s:keywords]', '[s:lyrics]',
            '[e:tags]', '[e:keywords]', '[e:lyrics]'
        ]
    }
    ...
    scheduler = WarmupLinearSchedule(optimizer, args.warmup_steps, optimization_steps)
